...
/// <summary>
/// Implements <see cref="IDynamoDBItemEventHandler"/> to handle 
/// optimistic concurrency and version management for DynamoDB items.
/// </summary>
public class VersionChecker : IDynamoDBItemEventHandler
{
    /// <summary>
    /// Marker value used instead of actual version indicating that version checks should be skipped for an operation.
    /// </summary>
